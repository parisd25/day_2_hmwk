...
function Person(name, age) {
    ...
    this.printInfo = (favorite_color, mission = 'I am here!') => {
        console.log(`What is your name? \"${this.name}\", 
                    \nWhat is your quest? \"${mission}\", 
...
let paris = new Person('Jack ', 29)
paris.printInfo('Blue')
console.log(paris.gotOlder());
console.log(paris.gotOlder());
console.log(paris.gotOlder());
console.log(paris.gotOlder());

let gwen = new Person('miss jack', 27)
gwen.printInfo('Blue... no, Yellow!')
